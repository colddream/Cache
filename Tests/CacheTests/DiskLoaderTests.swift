...
final class DiskLoaderTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        loader = ImageLoader(cache: try DiskStorage(config: .init(name: "DiskLoader", sizeLimit: 0)),
